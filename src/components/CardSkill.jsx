    ...
    return (
        <>
            {props.data.map((skill, index) => (
                <div key={index} className="mb-2 basis-full md:basis-[calc(33.333%-0.75rem)] max-w-full sm:max-w-[calc(50%-0.5rem)] md:max-w-[calc(33.333%-0.75rem)] ps-7 pe-7 p-3 bg-white border border-gray-200 rounded-lg shadow-md border-t-5 border-t-slate-900">
