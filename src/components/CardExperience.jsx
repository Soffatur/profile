                    ...
                    <div className="max-w-full ps-7 pe-7 p-3 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 border-t-5 border-t-slate-900">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="col-span-1">
                                ...
                                <p className="text-lg"><FontAwesomeIcon icon={faBuilding} size="lg" />{item.company}</p>
                            </div>
                            <div className="col-span-1 justify-end flex items-center">
                                <span className="bg-slate-900 text-white text-xs font-medium me-2 px-2.5 py-0.5 rounded-xl"><FontAwesomeIcon icon={faCalendar} />{item.date}</span>
                            </div>
