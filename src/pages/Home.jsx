            ...
            <div className="min-h-screen bg-gray-200 text-gray-500">
                <div className="grid grid-cols-8 gap-4 ps-5 pe-5 pt-10 mb-20">
                    <div className="col-span-8 md:col-span-4 md:col-start-3 mt-10 mb-10">
                        <h1 className="text-4xl font-bold text-center">Hello, I'm Muhammad Soffatur Rohman — a Backend Engineer focused on building reliable systems with Golang and scalable architectures.</h1>
                    </div>
